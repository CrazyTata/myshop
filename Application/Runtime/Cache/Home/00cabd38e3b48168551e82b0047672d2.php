			...
			<div class="goodslist mt10">
				<ul>
					<?php if(is_array($goodsInfo)): foreach($goodsInfo as $key=>$v): ?><li>
						<dl>
							<dt><a href="<?php echo U('Index/detail?goods_id='.$v['goods_id']);?>"><img src="<?php echo (ltrim($v["goods_logo"],'.')); ?>" alt="" /></a></dt>
							<dd><a href="<?php echo U('Index/detail?goods_id='.$v['goods_id']);?>"><?php echo (substr($v["goods_name"],'0','20')); ?></a></dt>
