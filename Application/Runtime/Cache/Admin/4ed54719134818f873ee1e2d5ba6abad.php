...
<body style="background:url(/Public/Admin/images/topbg.gif) repeat-x;">
    ...
    <div class="topright">
        <ul>
            <li><a href="<?php echo U('Main/lgout');?>" target="_parent">退出</a></li>
        </ul>
        <div class="user">
            <?php if(session('?mg_name') ): ?><span>欢迎您，<?php echo (session('mg_name')); ?></span>
            <?php else: ?>
                <a href="<?php echo U('Index/login');?>" target="_top">请登录</a><?php endif; ?>
        </div>
    </div>
</body>
