...
<body>
    ...
    <div class="rightinfo">
        <div class="tools">
            <ul class="toolbar">
                <a href="<?php echo U('Attribute/add');?>"><li><span><img src="/Public/Admin/images/t01.png" /></span>添加</li></a>
        ...
        <table class="tablelist">
            ...
            <tbody>
            <?php if(is_array($attrInfo)): foreach($attrInfo as $key=>$v): ?><tr>
                    <td>
                        <input name="" type="checkbox" value="" />
                    </td>
                    <td><?php echo ($v["attr_id"]); ?></td>
                    <td><?php echo ($v["attr_name"]); ?></td>
                    <td><?php echo ($v["attr_cate_id"]); ?></td>
